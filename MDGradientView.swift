...
class MDGradientView: UIControl {

    private var gradientLayer: CAGradientLayer!
    @IBInspectable var topColor: UIColor = .gray {
        didSet {
            setNeedsLayout()
        }
    }
...
//    }
    ...
    @IBInspectable var viewBorder: UIColor = .clear {
        didSet {
            setNeedsLayout()
        }
    }
    ...
    override func layoutSubviews() {
        ...
        self.layer.borderColor = viewBorder.cgColor
